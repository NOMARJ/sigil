    ...
    async def process_batch(self, batch: List[Dict[str, Any]]):
        ...
        for scan in batch:
            try:
                ...
                await self.db.insert('forge_classification', {
...
async def main():
    ...
    db_url = os.environ.get('SIGIL_DATABASE_URL') or \
            'Driver={ODBC Driver 18 for SQL Server};Server=tcp:sigil-sql-w2-46iy6y.database.windows.net,1433;Database=sigil;Uid=sigil_admin;Pwd=hUkVA6s1G7z4Smqf!;Encrypt=yes;TrustServerCertificate=no;'
