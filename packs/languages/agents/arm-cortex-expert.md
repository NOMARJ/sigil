...
- Implement **peripheral drivers** (I2C/SPI/UART/ADC/DAC/PWM/USB) with clean abstractions using HAL, bare-metal registers, or platform-specific libraries.
...
- Writing register-level drivers for I2C, SPI, UART, CAN, SDIO
...
- Cross-MCU messaging over SPI/I2C/USB/BLE
