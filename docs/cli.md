...
contribution to the score saturates. Without that cap, one Unicode data table
that matches a single rule 1,723 times outscores a genuine backdoor, and the
verdict measures file size rather than risk.
