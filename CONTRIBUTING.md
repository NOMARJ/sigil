...
file in `idna` — `tests/test_idna_uts46.py`, the UTS-46 conformance table —
matched `OBFUSC-CHAIN-008` 1,680 times, contributing 16,800 of the 19,140
points that made the package HIGH RISK. When you write a rule that
