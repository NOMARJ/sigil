...
class SessionManager:
    ...
    async def export_session_markdown(
        self, session_id: Optional[str] = None, share_token: Optional[str] = None
    ) -> str:
        """
        ...
        try:
            ...
            session = await self.get_session(
                session_id=session_id, share_token=share_token, require_ownership=False
            )
                ...
                if "response" in entry:
                    ...
                    if entry.get("type") == "investigation":
                        ...
                        if "analysis" in response:
                            lines.extend(["**Analysis**:", response["analysis"], ""])
                        ...
                        if "message" in response:
                            lines.extend(["**Response**:", response["message"], ""])
