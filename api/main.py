...
app = FastAPI(
    ...
    tags_metadata=[
        ...
        {"name": "metrics", "description": "Scanner performance metrics and false positive tracking"},
...
app.include_router(metrics.router)  # /api/metrics/* — Scanner metrics and false positive tracking
