...
class TestHealthChecks:
    ...
    async def test_health_check_manager(self, health_manager):
        ...
        # Find our test check
        test_check = next((c for c in result["checks"] if c["name"] == "manager_test"), None)
...
class TestMetrics:
    ...
    def test_path_normalization(self):
        ...
        path1 = middleware._normalize_path("/api/v1/users/123e4567-e89b-12d3-a456-426614174000/profile")
    ...
    def test_user_type_detection(self):
        ...
        request_human = Mock()
        request_human.headers = {"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"}
...
class TestMonitoringPerformance:
    ...
    def test_health_check_performance(self, test_client):
        ...
        assert detailed_time < 10.0, f"Detailed health checks too slow: {detailed_time}s"
    ...
    def test_metrics_collection_overhead(self, test_client):
        ...
        assert total_time < 10.0, f"Metrics collection too slow: {total_time}s for 100 requests"
