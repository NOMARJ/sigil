...
async def test_mark_test_file_as_false_positive(feedback_processor, sample_finding):
    ...
    print("✅ Test passed: Marking test file pattern as safe suppresses similar test files")


@pytest.mark.asyncio
async def test_confidence_adjustment_for_false_positive(feedback_processor, sample_finding):
