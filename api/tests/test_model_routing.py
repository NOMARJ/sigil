...
def test_simple_question():
    ...
    complexity, confidence, factors = complexity_scorer.score_task(
        task_type="chat", query="Is this safe?", context={}
    )
...
def test_trace_attack():
    ...
    complexity, confidence, factors = complexity_scorer.score_task(
        task_type="chat", query="Trace the attack chain through the code", context={}
    )
...
def test_attack_chain_task():
    ...
    complexity, confidence, factors = complexity_scorer.score_task(
        task_type="attack_chain", query=None, context={}
    )
...
def test_investigation_depths():
    ...
    for depth, expected_model in zip(depths, expected_models):
        complexity, confidence, factors = complexity_scorer.score_task(
            task_type="investigate", query=None, context={"depth": depth}
        )
        ...
        assert model == expected_model, (
            f"Expected {expected_model} for {depth}, got {model}"
        )
