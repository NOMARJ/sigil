...
"""
        ...
        assert "Base64 decoding detected" in prompt, "Static findings should be included"
        ...
        assert '"threat_category"' in prompt, "Should guide toward threat categorization"
        
        # Verify security analysis focus areas are covered
        assert "zero_day" in prompt.lower(), "Zero-day analysis should be included"
        assert "obfuscation" in prompt.lower(), "Obfuscation analysis should be included"  
