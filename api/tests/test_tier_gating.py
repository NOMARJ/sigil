...
class TestSubscriptionServiceTierLogic:
    ...
    async def test_check_pro_access_cancelled_pro(self):
        ...
        with patch.object(subscription_service, 'get_user_subscription') as mock_get_sub:
            ...
            has_access = await subscription_service.check_pro_access("cancelled_user_123")
    ...
    async def test_check_pro_access_past_due(self):
        ...
        with patch.object(subscription_service, 'get_user_subscription') as mock_get_sub:
            ...
            has_access = await subscription_service.check_pro_access("past_due_user_123")
...
class TestTierGatingAPIEndpoints:
    ...
    def test_scan_enhanced_endpoint_free_user_blocked(self, client: TestClient, auth_headers: dict[str, str]):
    ...
    def test_scan_capabilities_endpoint_free_user(self, client: TestClient, auth_headers: dict[str, str]):
    ...
    def test_scan_capabilities_endpoint_pro_user(self, client: TestClient, pro_auth_headers: dict[str, str]):
...
class TestTierGatingPerformance:
    ...
    async def test_concurrent_tier_checks(self):
        ...
        async def check_tier(user_id: str):
            with patch.object(subscription_service, 'get_user_subscription') as mock_sub:
...
class TestTierGatingEdgeCases:
    ...
    async def test_user_without_subscription_record(self):
        ...
        with patch('api.database.db.get_subscription') as mock_db:
            ...
            subscription = await subscription_service.get_user_subscription("no_sub_user")
