...
class ComplexityScorer:
    ...
    def score_task(
        ...
        if context:
            ...
            if context.get("model_override"):
                factors["context_factors"].append(
                    f"user_override:{context['model_override']}"
                )
    ...
    def recommend_model(
        self, complexity: TaskComplexity, allow_downgrade: bool = True
    ) -> str:
        """
    ...
    def estimate_credits(
        self, complexity: TaskComplexity, task_type: str
    ) -> Dict[str, int]:
        """
    ...
    def get_cost_comparison(
        self, complexity: TaskComplexity, task_type: str, recommended_model: str
    ) -> Dict[str, any]:
        """
