...
class LLMConfig:
    ...
    def __init__(self):
        ...
        self.fallback_to_static = os.getenv("LLM_FALLBACK_TO_STATIC", "true").lower() == "true"
    ...
    def get_endpoint_url(self) -> str:
        ...
        if self.api_base:
            ...
            raise ValueError("Azure LLM provider requires LLM_API_BASE environment variable")
        elif self.provider == "anthropic":
